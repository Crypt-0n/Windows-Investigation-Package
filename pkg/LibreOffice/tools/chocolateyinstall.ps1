...
$url        = 'https://download.documentfoundation.org/libreoffice/stable/6.2.7/win/x86/LibreOffice_6.2.7_Win_x86.msi' # download url, HTTPS preferred
$url64      = 'https://download.documentfoundation.org/libreoffice/stable/6.2.7/win/x86/LibreOffice_6.2.7_Win_x86.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'LibreOffice*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique

  # Checksums are now required as of 0.10.0.
  # To determine checksums, you can get that from the original site if provided. 
  # You can also use checksum.exe (choco install checksum) and use it 
  # e.g. checksum -t sha256 -f path\to\file
  checksum      = '1a09ce6f3a0ff8eb5550653580b606ad'
  checksumType  = 'md5' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = '1a09ce6f3a0ff8eb5550653580b606ad'
